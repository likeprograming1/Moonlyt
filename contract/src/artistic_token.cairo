...
mod ArtisticToken {
    ...
    fn constructor(
        ...
        self.storage.max_supply = max_supply;
        self.storage.token_id = 0;
    }
    ...
    impl ExternalImpl of ExternalTrait {
        ...
        fn safe_mint(
            ...
            let token_id = self.storage.token_id;

            assert!(token_id + 1 < self.storage.max_supply, "Max NFT supply reached");

            self.erc721._safe_mint(recipient, token_id, data);
            self.erc721._set_token_uri(token_id, token_uri);
            self.storage.next_token_id += 1;
        }
